...
FPS=32  #Frames per second i.e changing of images per second so that there is no lag
SCREENWIDTH=289
SCREENHEIGHT=511
SCREEN=pygame.display.set_mode((SCREENWIDTH,SCREENHEIGHT))#Initialize a screen or window for display
...
def mainGame():
    ...
    while True :
        ...
        #Add a new pipe when the first pipe is about to go to left part of the screen
...
if __name__ == '__main__':
    ...
    FPSCLOCK=pygame.time.Clock() # class Clock() -> Clock create an object to help track time and time module helps in monitoring time
    pygame.display.set_caption("Flappy Bird by Om Gori")
    ...
    while True :
        welcomeScreen() #Shows welcome screen to the user until any key is pressed by user
